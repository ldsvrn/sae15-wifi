...
if __name__ == '__main__':
    ...
    parser.add_argument("--keepids", help="keep IDs that are not integers", nargs='?', const=True, type=bool ,default=False)
    ...
    # TODO: quel réseaux wifi garder? ExpId avec virgules???
